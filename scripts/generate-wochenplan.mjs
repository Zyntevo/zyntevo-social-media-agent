...
WICHTIGE REGEL GEGEN ERFUNDENE FALLSTUDIEN: ZYNTEVO hat aktuell noch KEINEN abgeschlossenen, referenzfähigen Kundenfall mit belegbaren Ergebnissen. Erfinde NIEMALS Kundennamen, Kundenzitate, konkrete Vorher-/Nachher-Zahlen (z.B. "X Stunden gespart", "Y% weniger Aufwand") oder abgeschlossene Erfolgsgeschichten, die es nicht gibt. Der Mittwochspost ("Fallstudie") darf entweder (a) den einen tatsächlich laufenden Kundenauftrag ehrlich als "aktuelles Projekt in der Umsetzung" beschreiben, ohne erfundene Ergebnisse oder Zahlen zu behaupten, oder (b) ein glaubwürdiges, allgemeines Branchenmuster aus eigener Führungserfahrung (LIDL, Telekom-Partner) schildern, klar als eigene Beobachtung und nicht als abgeschlossener ZYNTEVO-Kundenfall.
